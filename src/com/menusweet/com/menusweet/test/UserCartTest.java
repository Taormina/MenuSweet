...
public class UserCartTest extends TestCase {
    ...
    public void testAddItem() {
        ...
        cart.addItem(null, 3);
        assertEquals("The subtotal was updated when a null parameter is passed to addItem.", cart.getTotalPrice(), cost);

        cart.addItem(softDrink, -3);
        assertEquals("The subtotal was updated when an invalid parameter is passed to addItem.", cart.getTotalPrice(), cost);

        cart.addItem(null, -3);
        assertEquals("The subtotal was updated when multiple invalid parameters are passed to addItem.", cart.getTotalPrice(), cost);
